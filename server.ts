...
const state: ServerState = {
  users: [
    ...
    },
    {
      ...
      password: '123456',
      referralCode: 'APNAX28',
      referredBy: 'AT10001',
      referredByCode: 'AT10001',
      sponsorName: 'Super Admin',
      depositWallet: 0,
      ticketWallet: 0,
      winningWallet: 0,
      walletBalance: 0,
      ...
      freeTicketsAvailable: 0,
      role: 'user',
      createdAt: '2026-08-31T21:04:34.769Z',
      ageVerified: true,
      stateOfResidence: 'Maharashtra',
      isKycVerified: true,
    },
    {
      ...
      name: 'Ashutosh',
      phone: '7385427571',
      email: 'ashutosh@apnatambola.com',
      password: '123456',
      referralCode: 'AT578579',
      referredBy: 'AT10001',
      referredByCode: 'AT10001',
      sponsorName: 'Super Admin',
      depositWallet: 1000,
    ...
    },
    {
      ...
      password: '123456',
      referralCode: 'APNA6KX',
      referredBy: 'AT578579',
      referredByCode: 'AT578579',
      sponsorName: 'Ashutosh',
      depositWallet: 0,
      ticketWallet: 0,
      winningWallet: 0,
      walletBalance: 0,
    ...
    },
    {
      ...
      name: 'Aniket',
      phone: '7841817431',
      email: 'aniketblessy@gmail.com',
      password: 'aniket123',
      referralCode: 'APNAN6S',
      referredBy: 'AT578579',
      referredByCode: 'AT578579',
      sponsorName: 'Ashutosh',
      depositWallet: 0,
    ...
    },
    {
      ...
      freeTicketsAvailable: 0,
      role: 'user',
      createdAt: '2026-08-31T21:19:11.513Z',
      ageVerified: true,
      stateOfResidence: 'India',
      isKycVerified: false,
    },
    {
      id: 'AT359097',
      ...
      freeTicketsAvailable: 0,
      role: 'user',
      createdAt: '2026-08-31T21:19:16.862Z',
      ageVerified: true,
      stateOfResidence: 'India',
      isKycVerified: false,
    },
    {
      id: 'AT999999',
      name: 'Self Refer Test',
      phone: '9833445566',
      email: 'selfrefer@example.com',
      password: 'Password@123',
      referralCode: 'APNATXY',
      referredBy: 'USR-ADMIN',
      referredByCode: 'APNA999',
      sponsorName: 'Apna Tambola Super Admin',
      depositWallet: 0,
      ticketWallet: 0,
      winningWallet: 0,
      walletBalance: 0,
      ...
      freeTicketsAvailable: 0,
      role: 'user',
      createdAt: '2026-08-31T21:19:27.869Z',
      ageVerified: true,
      stateOfResidence: 'India',
      isKycVerified: false,
    },
    {
      ...
      freeTicketsAvailable: 0,
      role: 'user',
      createdAt: '2026-08-31T21:19:34.367Z',
      ageVerified: true,
      stateOfResidence: 'India',
      isKycVerified: false,
    },
    {
      ...
      freeTicketsAvailable: 0,
      role: 'user',
      createdAt: '2026-08-31T23:24:40.241Z',
      ageVerified: true,
      stateOfResidence: 'India',
      isKycVerified: false,
    },
    {
      id: 'AT915359',
      name: 'Simulated User B',
      phone: '9876500001',
      email: 'sim_b@example.com',
      password: 'password123',
      referralCode: 'APNAK5V',
      referredBy: null,
      depositWallet: 0,
      ticketWallet: 0,
      winningWallet: 0,
      ...
      freeTicketsAvailable: 0,
      role: 'user',
      createdAt: '2026-08-31T20:59:44.313Z',
      ageVerified: true,
      stateOfResidence: 'India',
      isKycVerified: false,
    },
    {
      id: 'AT392476',
      name: 'Simulated User C',
      phone: '9876500002',
      email: 'sim_c@example.com',
      password: 'password123',
      referralCode: 'APNA8VF',
      referredBy: null,
      depositWallet: 0,
      ticketWallet: 0,
      winningWallet: 0,
      ...
      freeTicketsAvailable: 0,
      role: 'user',
      createdAt: '2026-08-31T20:59:44.328Z',
      ageVerified: true,
      stateOfResidence: 'India',
      isKycVerified: false,
    },
    {
      ...
      name: 'Simulated User B',
      phone: '9876590522',
      email: 'sim_b_1788210018273@example.com',
      password: 'password123',
      referralCode: 'APNAUG5',
      referredBy: 'USR-101',
      referredByCode: 'APNA100',
      sponsorName: 'Rajesh Sharma',
      depositWallet: 0,
      ...
      freeTicketsAvailable: 0,
      role: 'user',
      createdAt: '2026-08-31T21:00:18.385Z',
      ageVerified: true,
      stateOfResidence: 'India',
      isKycVerified: false,
    },
    {
      ...
      name: 'Simulated User C',
      phone: '9876514073',
      email: 'sim_c_1788210018273@example.com',
      password: 'password123',
      referralCode: 'APNAJJD',
      referredBy: 'AT338721',
      referredByCode: 'APNAUG5',
      sponsorName: 'Simulated User B',
      depositWallet: 0,
      ticketWallet: 0,
      winningWallet: 0,
      walletBalance: 0,
      ...
      freeTicketsAvailable: 0,
      role: 'user',
      createdAt: '2026-08-31T21:00:18.401Z',
      ageVerified: true,
      stateOfResidence: 'India',
      isKycVerified: false,
    },
...
app.post('/api/auth/login', (req: Request, res: Response) => {
  try {
    ...
    const user = state.users.find((u) => {
      ...
      const matchRef = u.referralCode?.toLowerCase() === cleanInput;
      const matchName = u.name?.toLowerCase() === cleanInput;
      const uPhoneDigits = (u.phone || '').replace(/[^0-9]/g, '');
      const matchPhone = (cleanDigits.length >= 7 && (uPhoneDigits.endsWith(cleanDigits) || cleanDigits.endsWith(uPhoneDigits))) ||
        (cleanDigits.length >= 10 && uPhoneDigits.slice(-10) === cleanDigits.slice(-10));
      return matchEmail || matchId || matchRef || matchPhone || matchName;
    });

    if (!user) {
      return res.status(401).json({ error: 'Invalid Mobile/Email/User ID or Referral Code. Please check your credentials or Register.' });
    }
    ...
    // Password validation (allows user password, 123456, Password@123, aniket123, password123, Admin@2026)
