        ...
        {mode === 'register' && (
          <form onSubmit={handleRegister} className="space-y-3">
            ...
            <div className="relative flex py-2 items-center">
              ...
              <span className="flex-shrink mx-2 text-[10px] text-slate-400 font-bold uppercase tracking-wider">or sign in with</span>
              <div className="flex-grow border-t border-white/10"></div>
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-2.5 rounded-xl bg-white hover:bg-slate-100 text-slate-900 font-bold text-xs shadow-md flex items-center justify-center gap-2.5 transition-all cursor-pointer disabled:opacity-50"
            >
