        ...
        {submitted ? (
          ...
          <div className="py-4 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
              ...
              <a
                href="mailto:support@apnatambola.com?subject=APNA%20TAMBOLA%20Player%20Query"
              ...
              >
                ...
                <span className="text-[9px] text-blue-300/80 font-normal truncate max-w-[110px]">support@apnatambola.com</span>
              </a>
            </div>
            ...
            <div className="p-2.5 rounded-xl bg-sky-950/40 border border-sky-500/30 text-[11px] text-sky-200 flex items-center justify-between">
              ...
              <strong className="font-mono text-cyan-300 select-all">support@apnatambola.com</strong>
            </div>
