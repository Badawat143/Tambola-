...
export const ReferralSection: React.FC = () => {
  ...
  const handleShareWhatsApp = () => {
    const text = `Hey! Join me on APNA TAMBOLA and play live Tambola games to win real cash! Use my Referral Code ${currentUser.referralCode} or sign up here: ${downlineStats.referralLink}`;
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#121035] via-[#1a0f3c] to-[#0c0d24] border-2 border-purple-500/30 p-6 sm:p-10 shadow-2xl">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/40 text-purple-300 text-xs font-bold uppercase tracking-wider mb-3">
            ...
            <span>8-LEVEL PASSIVE COMMISSION ENGINE (4.6% TOTAL)</span>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <div className="glass-card rounded-2xl p-4 sm:p-5 border border-emerald-500/30 bg-[#0f1130]/90">
            ...
            <p className="text-[10px] text-emerald-300/80 mt-1">Separate from ₹{currentUser.gameWinnings} Game Winnings</p>
          </div>
        </div>

        {/* 1-Click Referral Link Box */}
        <div className="glass-card rounded-2xl p-4 sm:p-5 border border-white/15 bg-[#0b0c24] mb-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            <button
              ...
              className="flex-1 md:flex-none px-5 py-2.5 rounded-xl bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white text-xs font-extrabold flex items-center justify-center gap-1.5 shadow-md transition-all cursor-pointer"
            >
            ...
            <button
              ...
              className="flex-1 md:flex-none px-5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-extrabold flex items-center justify-center gap-1.5 shadow-md transition-all cursor-pointer"
            >
        ...
        {/* Live Downline Verification & Network Switcher (Ensures exact user requirements test) */}
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-3">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-purple-500/20 hover:bg-purple-500/30 border border-purple-500/40 text-purple-300 text-xs font-bold transition-all cursor-pointer"
              >
                Switch Test Account
              </button>
              <button
