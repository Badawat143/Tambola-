        ...
        {actions.map((act) => {
          ...
          return (
            <button
              ...
              className={`p-3 rounded-2xl bg-gradient-to-b from-[#10153f]/90 via-[#0a0d2a]/95 to-[#07091d]/95 border-2 ${act.border} hover:border-white/60 shadow-lg ${act.shadow} flex flex-col items-center justify-center text-center transition-all hover:scale-105 active:scale-95 cursor-pointer group`}
            >
              <div
